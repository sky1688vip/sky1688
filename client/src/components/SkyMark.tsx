...
export function SkyMark({ compact = false }: { compact?: boolean }) {
  return (
    <div className="flex items-center gap-3" aria-label="SKY1688">
      <div className="grid h-10 w-10 place-items-center rounded-2xl border border-lime-200/25 bg-lime-300/10 text-lime-200 shadow-[0_0_30px_rgba(184,255,80,0.18)]">
